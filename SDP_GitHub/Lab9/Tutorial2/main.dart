import 'Quotes.dart';
import 'package:lab9/Tutorial2/pages/Home.dart';
import 'package:flutter/material.dart';
import 'package:lab9/Tutorial2/pages/choose_location.dart';
import 'package:lab9/Tutorial2/pages/loading.dart';

//void main()=> runApp(MaterialApp(home:Home(),));
void main() {
  return runApp(MaterialApp(initialRoute: '/home', routes: {
    '/': (context) => Loading(),
    '/home': (context) => Home(),
